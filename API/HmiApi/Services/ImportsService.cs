...
namespace HmiApi.Services{
    public class ImportsService : BaseService{
        public ImportsService(HmiApiDbContext context) : base(context){
        }
        ...
        //public async Task<IActionResult> SaveFile(ICollection<IFormFile> files, string token, string id){
        //}
